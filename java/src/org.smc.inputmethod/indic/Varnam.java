...
public class Varnam {
    ...
    public String transliterate (String input) {
        String baseUrl = "https://api.varnamproject.com/tl/";
        baseUrl = baseUrl + getLanguage() + "/";
        String urlString = baseUrl + input;
        ...
        try {
            ...
            //As a new word is being transliterated the suggestions must be cleared
            suggestions.clear();

            for (int i = 0; i < dummy.length(); i++) {
                suggestions.add(dummy.getString(i));
            }
            //Return the most apt transliterated word
    ...
    //Return a list of SuggestedWordInfo to display on the SuggestionStripView
